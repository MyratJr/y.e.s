...
urlpatterns = [
    ...
    path('service-gallery-destroy/<uuid:pk>/', views.Service_Gallery_DestroyView.as_view(), name='service_gallery_destroy'),
    path('service-categories/', views.All_CategoriesAPIView.as_view(), name='service_categories'),
    path('like-service/<uuid:pk>/', views.LikeServiceAPIView.as_view(), name='like_user'),
