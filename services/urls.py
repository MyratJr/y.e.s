...
urlpatterns = [
    ...
    path('home-service-categories', views.HomeServiceCategoriesView, name='home_service_categories'),
    path('home-advertisement', views.HomeAdvertisementView, name='home_advertisements')
]